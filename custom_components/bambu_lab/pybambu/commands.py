...
SPEED_PROFILE_TEMPLATE = {"print": {"sequence_id": "2004", "command": "print_speed", "param": ""}, "user_id": "123456789"}

GET_VERSION = {"info": {"sequence_id": "20004", "command": "get_version"}, "user_id": "123456789"}
...
PUSH_ALL = {"pushing": {"sequence_id": "1", "command": "pushall"}, "user_id": "123456789"}

SEND_GCODE_TEMPLATE = {"print": {"sequence_id": "2026", "command": "gcode_line", "param": ""}, "user_id": "123456789"} # param = GCODE_EACH_LINE_SEPARATED_BY_\n
