...
For all actions the target device or entity is passed as a field parameter. In a cases involving an AMS tray, this must be an entity id. In all other cases a device id.
