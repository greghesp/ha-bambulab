...
| Sensor         | Notes                                                      |
| -------------- | ---------------------------------------------------------- |
| Hotend 1-6     | Nozzle type per rack slot (e.g. "0.4mm Standard") or Empty |
| Active hotend  | Currently mounted hotend                                   |

| Hotend attributes: | Notes                            |
| ------------------ | -------------------------------- |
| Diameter           |                                  |
| Flow type          | Standard or High Flow            |
| Type               |                                  |
| Type code          |                                  |
| Serial             |                                  |
| Max temperature    |                                  |
...
Active hotend has additional attributes:

| Attribute      | Notes                            |
| -------------- | -------------------------------- |
| ID             | Hotend number (1-6)              |
| Source hotend  | Previously mounted hotend number |
